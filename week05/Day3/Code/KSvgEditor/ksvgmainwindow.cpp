...
{
	//KShapeBase* shape = KShapeFactory::createShape(KGlobalData::KDrawFlag::RectFlag);
	//shape->setStartPoint(QPoint(40, 40));
	//shape->setEndPoint(QPoint(100, 100));
	///*shape->setBrush(m_pCanvas);*/
...
{
	m_canvasWidth = KGlobalData::getGlobalDataInstance()->canvasWidth();
	m_canvasHeight = KGlobalData::getGlobalDataInstance()->canvasHeight();
